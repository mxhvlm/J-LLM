package org.example.impl.pipeline.llm.oneSentenceSummary;
...
import org.example.impl.datamodel.impl.neo4j.Neo4jSummary;
import org.example.impl.integration.api.llm.ILLMConfig;
import org.example.impl.integration.api.llm.ILLMProvider;
import org.example.impl.pipeline.llm.AbstractLLMTransformStep;
...
class SummaryTransformStep
    ...
    public SummaryTransformStep(ILLMProvider llmProvider, ILLMConfig config) {
    ...
    @Override
    public ILLMConfig getLLMConfig(Neo4jMethodSummaryContextResult input) {
        return _config;
    }
