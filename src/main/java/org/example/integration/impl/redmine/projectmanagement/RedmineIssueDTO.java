...
import org.example.integration.impl.shared.TicketField;
...
public record RedmineIssueDTO(
    ...
    public Optional<IField> getField(String fieldName) {
        return switch (fieldName) {
            ...
            case "fixed_version" -> Optional.of(new TicketField("fixed_version", fixed_version() != null ? fixed_version().name() : ""));
            ...
            case "done_ratio" -> Optional.of(new TicketField("done_ratio", done_ratio != null ? done_ratio.toString() : ""));
            case "is_private" -> Optional.of(new TicketField("is_private", is_private != null ? is_private.toString() : ""));
            case "created_on" -> Optional.of(new TicketField("created_on", created_on != null ? created_on.toString() : ""));
            case "updated_on" -> Optional.of(new TicketField("updated_on", updated_on != null ? updated_on.toString() : ""));
            case "closed_on" -> Optional.of(new TicketField("closed_on", closed_on != null ? closed_on.toString() : ""));
